    ...
    <>
      ...
      {showFeatured && (
        <div style={{ marginBottom: 'clamp(24px,4vw,48px)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 28 }}>
            ...
            <span style={{ fontFamily: 'var(--font-montserrat)', fontSize: '0.55rem', fontWeight: 700, letterSpacing: '0.24em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.28)', whiteSpace: 'nowrap' }}>Guides essentiels</span>
            <div style={{ flex: 1, height: 1, background: 'rgba(255,255,255,0.06)' }} />
          </div>
              ...
              return (
                <Link key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column' }}>
                  <article style={{
                    ...
                    <p style={{ fontFamily: 'var(--font-dm-sans)', fontWeight: 300, fontSize: '0.875rem', lineHeight: 1.72, color: 'rgba(255,255,255,0.42)', margin: '0 0 auto', paddingBottom: 20 }}>{post.excerpt}</p>
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', paddingTop: 14, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
                      <span style={{ fontFamily: 'var(--font-montserrat)', fontSize: '0.52rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.22)' }}>{post.readTime} de lecture</span>
      ...
      {filtered.length > 0 ? (
              ...
              <Link key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column' }}>
                <article className="blog-card" style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, marginBottom: 18 }}>
                    ...
                    <span style={{ fontFamily: 'var(--font-montserrat)', fontSize: '0.5rem', fontWeight: 600, letterSpacing: '0.1em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.25)' }}>{post.readTime} de lecture</span>
                  </div>
        ...
        <div style={{ textAlign: 'center', padding: 'clamp(48px,8vw,96px) 0' }}>
          <p style={{ fontFamily: 'var(--font-bebas)', fontSize: 'clamp(2rem,4vw,3rem)', color: 'rgba(255,255,255,0.12)', letterSpacing: '0.06em', margin: '0 0 12px' }}>AUCUN RÉSULTAT</p>
          <p style={{ fontFamily: 'var(--font-dm-sans)', fontSize: '0.9rem', color: 'rgba(255,255,255,0.3)', margin: 0 }}>Essaie un autre mot-clé — visa, logement, caf, maroc, algérie…</p>
        </div>
      ) : null}
    </>
  );
